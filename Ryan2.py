...
#cl.login(qr=True)
cl.login(token="EobxVvJjt3OaBpZC1RWa.hZwh5IdXSacGZzoHucpP2G.W0s5bCTJPrPu6GFwNLpA9c2rocVpASiMdhFTWY4t4FI=")
cl.loginResult()
...
print "􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿
Owner : ✰Babang__Adhi✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Help
...
targets = []
Bots=[mid]
induk=[mid,"u1f3587e620f1b000a0cd93a15023e9da"]
Creator=["u1f3587e620f1b000a0cd93a15023e9da"]
admin=["u1f3587e620f1b000a0cd93a15023e9da"]
owner=["u1f3587e620f1b000a0cd93a15023e9da"]
wait = {
    'contact':False,
    'autoJoin':True,
...
Idline: http://line.me/ti/p/boy29putra""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ B by »»» http://line.me/ti/p/bo29putra «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "u1f3587e620f1b000a0cd93a15023e9da"
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Bah kenapa dia 😊")
